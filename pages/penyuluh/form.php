...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-extrabold text-neutral-900 tracking-tight"><?= $is_edit ? 'Edit Data & Wilayah Penyuluh' : 'Tambah Penyuluh Baru' ?></h1>
        <p class="text-xs font-medium text-neutral-500 mt-1">Kelola biodata penyuluh kehutanan dan alokasi wilayah kerja binaan.</p>
    </div>
    <a href="<?= BASE_URL ?>/index.php?page=penyuluh" class="text-xs font-semibold text-neutral-600 hover:text-neutral-900 flex items-center bg-white border border-neutral-200 px-3.5 py-2 rounded-xl shadow-xs transition-all">
        <i data-lucide="arrow-left" class="w-4 h-4 mr-1.5"></i> Kembali ke Data Penyuluh
    </a>
</div>

<div class="bg-white rounded-3xl border border-neutral-200/60 shadow-card overflow-hidden max-w-4xl" x-data="penyuluhManager()">
    <form action="<?= BASE_URL ?>/index.php?page=users/process" method="POST" class="p-6 sm:p-8 space-y-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label class="block text-xs font-semibold uppercase tracking-wider text-neutral-600 mb-1.5">NIP Penyuluh <span class="text-rose-500">*</span></label>
                ...
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold uppercase tracking-wider text-neutral-600 mb-1.5">Password Login <?= $is_edit ? '<span class="text-xs text-neutral-400 font-normal lowercase">(kosongkan jika tidak diubah)</span>' : '<span class="text-rose-500">*</span>' ?></label>
